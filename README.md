...
Replace **`/sglang-jax/benchmark/moe/bench_ep_moe.py`** with your actual script path.
...
>
> **[Objective]**
> Run `/Users/hongmao/workplace/sglang-jax/benchmark/moe/bench_ep_moe.py` on a TPU cluster by provisioning the full GKE infrastructure from scratch, following the complete `apply-resource → deploy-cluster → exec-remote` pipeline.
>
> **[Style]**

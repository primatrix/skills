...
Replace `src/train.py` with your actual script path.
...
>
> **[Objective]**
> Run `src/train.py` on a TPU cluster by provisioning the full GKE infrastructure from scratch, following the complete `apply-resource → deploy-cluster → exec-remote` pipeline.
>
> **[Style]**

...
TPU_CONFIG_MAP = {
    ...
    "v6e-1":   {"accelerator": "tpu-v6e-slice", "topology": "1x1", "chips_per_host": 1, "num_nodes": 1},
    "v6e-4":   {"accelerator": "tpu-v6e-slice", "topology": "2x2", "chips_per_host": 4, "num_nodes": 1},
    "v6e-8":   {"accelerator": "tpu-v6e-slice", "topology": "2x4", "chips_per_host": 4, "num_nodes": 2},
    "v6e-16":  {"accelerator": "tpu-v6e-slice", "topology": "4x4",  "chips_per_host": 4, "num_nodes": 4},
    "v6e-32":  {"accelerator": "tpu-v6e-slice", "topology": "4x8",  "chips_per_host": 4, "num_nodes": 8},
    "v6e-64":  {"accelerator": "tpu-v6e-slice", "topology": "8x8",  "chips_per_host": 4, "num_nodes": 16},
    "v6e-128": {"accelerator": "tpu-v6e-slice", "topology": "8x16", "chips_per_host": 4, "num_nodes": 32},
    "v6e-256": {"accelerator": "tpu-v6e-slice", "topology": "16x16","chips_per_host": 4, "num_nodes": 64},
}
...
if __name__ == "__main__":
    ...
    print(f"{'Type':<10} {'Accelerator':<18} {'Topology':<10} {'Chips/Host':<12} {'Nodes'}")
    print("-" * 65)
    for tpu_type in list_supported_types():
        cfg = TPU_CONFIG_MAP[tpu_type]
        print(f"{tpu_type:<10} {cfg['accelerator']:<18} {cfg['topology']:<10} {cfg['chips_per_host']:<12} {cfg['num_nodes']}")
